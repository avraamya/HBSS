...
int main()
{
    ...
    MEASURE("Sign message...        ", N_SIGNATURES_TOTAL, sign(message, &signature, key_pair.Seeds, key_pair.root));
    MEASURE("Verify signature...    ", N_SIGNATURES_TOTAL, verify(message, &signature, key_pair.root));
