...
int main()
{
    ...
    stateless_lamport_key_pair key_pair;
    stateless_lamport_signature signature;
    ...
    MEASURE("Sign message...        ", N_SIGNATURES_TOTAL, sign(message, &signature, key_pair.secret_key));
    MEASURE("Verify signature...    ", N_SIGNATURES_TOTAL, verify(message, &signature, key_pair.public_key));
